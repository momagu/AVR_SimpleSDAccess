...
#elif defined(__AVR_ATxmega32E5__)								// Xmega defines
    #define configure_pin_mosi()	PORTC.DIRSET = PIN7_bm;
    #define configure_pin_sck()		PORTC.DIRSET = PIN5_bm;
    #define configure_pin_ss()		PORTC.DIRSET = PIN4_bm;
    #define configure_pin_miso()	PORTC.DIRCLR = PIN6_bm;

    #define select_card()			PORTC.OUTCLR = PIN4_bm;
    #define unselect_card()			PORTC.OUTSET = PIN4_bm;
#else
